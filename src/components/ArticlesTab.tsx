...
const articleCategories: Category[] = [
  {
    ...
    articles: [
      { 
        ...
        source: "FinQuest Akademi", readTime: "4 dk", 
      ...
      { 
        ...
        source: "FinQuest Akademi", readTime: "3 dk", 
  ...
  },
  {
    ...
    articles: [
      ...
      { 
        ...
        source: "FinQuest Akademi", readTime: "2 dk", 
      ...
      { 
        ...
        source: "FinQuest Akademi", readTime: "5 dk", 
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Finans dünyasını daha iyi anlaman için FinQuest Akademi tarafından hazırlanmış eğitimler.
              </p>
            </div>
          </div>
        </header>
            ...
            >
              <div className="p-4 border-b border-border flex items-center justify-between bg-card z-10 sticky top-0">
                <div className="flex items-center gap-2 text-sm font-bold text-muted-foreground">
                  <BookText className="w-4 h-4" /> FinQuest Okuma Modu
                </div>
